...
const ThemeToggle = ({ theme, setTheme }) => {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.92 }}
      className={`fixed bottom-6 right-6 z-[99999] px-4 py-2.5 md:px-5 md:py-3 rounded-full flex items-center gap-3 shadow-2xl backdrop-blur-md border-2 transition-all duration-300 pointer-events-auto cursor-pointer ${
        isColor 
