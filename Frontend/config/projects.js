export const projectsData = [
    ...
    },
    {
        ...
        'video': 'https://res.cloudinary.com/dc8ryewn6/video/upload/f_auto,q_auto/v1789906897/Leeto_ai_10sec_orange_black_lxzypu.mp4',
        'image': ''
    },
    {
        'id': 6,
        'project_name': 'Repodoc AI',
        'desc': 'An AI application that analyzes GitHub code repositories to automatically generate technical documentation, setup guides, user manuals, and interview prep materials.',
        'technical_skills': ['React', 'FastAPI', 'Python', 'LLMs'],
        'live_link': '',
        'github_link': '',
        'video': 'https://res.cloudinary.com/dc8ryewn6/video/upload/f_auto,q_auto/v1789906897/RepoDoc_ai_10sec_blue_theme_h264_jlwaqt.mp4',
        'image': ''
    }
]